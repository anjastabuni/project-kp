        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-md border border-gray-300">
                ...
                <div class="px-6 py-4 flex justify-end">
                    <a href="{{ route('ketua-prodi.profil.edit', $user->id) }}" class="bg-yellow-500 text-gray-800 px-3 py-1 rounded hover:bg-yellow-600 transition-colors duration-300">Edit</a>
