...
<body class="h-full flex items-center justify-center">
  <div class="flex  max-w-4xl bg-white shadow-lg rounded-lg overflow-hidden">
    ...
    <div class="lg:flex lg:w-1/2 bg-gray-100 p-8 items-center justify-center flex-col text-center">
      ...
      <h1 class="text-3xl font-bold text-gray-900">SIP Teknik Informatika</h1>
    ...
    <div class="flex flex-1 flex-col justify-center px-6 py-12 lg:w-1/2">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            <a href="{{ route('staf.dashboard') }}" type="submit" class="flex w-full justify-center rounded-md bg-yellow-500 px-4 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-yellow-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-500">Masuk</a>
          </div>
        </form>
      </div>
    </div>
