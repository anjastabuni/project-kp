<x-app-layout>
    <div class="container mx-auto mt-10">
        ...
        <form action="{{ route('ketua-prodi.profil.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('ketua-prodi.profil.index', $user->id) }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg shadow hover:bg-gray-600 transition-colors duration-300 mr-2">Batal</a>
