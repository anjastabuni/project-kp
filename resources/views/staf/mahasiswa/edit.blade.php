<x-layout>
  <div class="container mx-auto py-12 px-4">
      <h2 class="text-3xl font-bold mb-8 text-gray-900 text-center">Edit Data Mahasiswa</h2>
      <form action="{{ route('staf.mahasiswa.update', $mahasiswa->npm) }}" method="post">
          ...
          <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg">
              <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-8">
                  ...
                  <!-- Email (dihapus dari komentar jika diperlukan) -->
                  {{-- <div class="col-span-1">
              ...
              <button type="submit" class="mt-6 w-full rounded-md bg-yellow-500 text-gray-800 px-4 py-2 hover:bg-yellow-600 transition-colors duration-300">Perbarui</button>
          </div>
      </form>
  </div>
</x-layout>
